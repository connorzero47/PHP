...
if (isset($_GET['distance']) && isset($_GET['stops'])) {
    if (is_numeric($_GET['distance']) && is_numeric($_GET['stops'])) {
        ...
        if (isset($_GET['weather']) && $_GET['weather'] == "good") {
...
<p><input type="text" name="distance" value="<?php if (isset($_GET['distance'])) echo $_GET['distance']; else echo 0; ?>" /> Distance (in miles)</p>
<p><input type="text" name="stops" value="<?php if (isset($_GET['stops'])) echo $_GET['stops']; else echo 0; ?>" /> Number of Stops</p>
